...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        for x in range(width):
            for y in range(height):
                k = str("(" + str(x) + "," + str(y) + ")")
                self.tileStatus.append([k, False])
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        k = str("(" + str(int(pos.getX())) + "," + str(int(pos.getY())) + ")")
...
def testProblem1():
    ...
    test.cleanTileAtPosition(Position(4, 4))
...
def testProblem2():
    ...
    print("Direction: {}".format(robot1.getRobotDirection()))
    robot1.setRobotPosition(Position(6.0, 5.2))
    print("Position: {}".format(robot1.getRobotPosition()))
