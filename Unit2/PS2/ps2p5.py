...
#
def testProblem6_1():
    showPlot1('Plot1 Test6.1', 'Number of Robots', 'Number of Simulations')
...
#
def testProblem6_2():
    showPlot2('Plot2 Test6.2', 'Aspect Ratios of Room', 'Number of Simulations')
...
def testProblem5():
    ...
    print("Test 0: - Average Simulation")
    print("My Simulation:\tStandard\t{:0.3f}".
          format(runSimulation(1, 1.0, 10, 10, 0.75, 30, StandardRobot)))
    print("My Simulation:\tRandom\t\t{:0.3f}".
          format(runSimulation(1, 1.0, 10, 10, 0.75, 30, RandomWalkRobot)))
    print("Test 1: - Average Simulation")
    print("My Simulation:\tStandard\t{:0.3f}".
          format(runSimulation(1, 1.0, 5, 5, 1.0, 30, StandardRobot)))
    print("My Simulation:\tRandom\t\t{:0.3f}".
          format(runSimulation(1, 1.0, 5, 5, 1.0, 30, RandomWalkRobot)))
    print("Test 2: - Average Simulation")
    print("My Simulation:\tStandard\t{:0.3f}".
          format(runSimulation(3, 1.0, 10, 10, 0.75, 30, StandardRobot)))
    print("My Simulation:\tRandom\t\t{:0.3f}".
          format(runSimulation(3, 1.0, 10, 10, 0.75, 30, RandomWalkRobot)))
    print("Test 3: - Average Simulation")
    print("My Simulation:\tStandard\t{:0.3f}".
          format(runSimulation(2, 1.0, 10, 10, 0.90, 30, StandardRobot)))
    print("My Simulation:\tRandom\t\t{:0.3f}".
          format(runSimulation(2, 1.0, 10, 10, 0.90, 30, RandomWalkRobot)))
